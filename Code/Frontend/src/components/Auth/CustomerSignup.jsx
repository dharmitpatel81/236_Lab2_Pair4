...
const CustomerSignup = () => {
    ...
    const handleFileChange = async (e) => {
        ...
        try {
            ...
            setCustomer({ ...customer, imageUrl: response.data.filePath }); // Saving file path
        } catch (error) {
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="firstName" value={customer.firstName} onChange={handleChange} required />
                        </div>
                        <div className="mb-3">
                    ...
                    <div className="col-md-6">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name="lastName" value={customer.lastName} onChange={handleChange} required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="dateOfBirth">Date of Birth <span className="text-danger">*</span></label>
                            <input type="date" className="form-control" name="dateOfBirth" value={customer.dateOfBirth} onChange={handleChange} required />
                        </div>
                        <div className="mb-3">
                            <label>Address <span className="text-danger">*</span></label>
                            <div className="mb-3">
                                <label htmlFor="street">Street</label>
                                <input type="text" className="form-control" name="street" value={customer.addresses[0].street} onChange={(e) => {
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" name="city" value={customer.addresses[0].city} onChange={(e) => {
                                    const newAddresses = [...customer.addresses];
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" name="state" value={customer.addresses[0].state} onChange={(e) => {
                                    const newAddresses = [...customer.addresses];
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" name="zipCode" value={customer.addresses[0].zipCode} onChange={(e) => {
                                    const newAddresses = [...customer.addresses];
                        ...
                        <div className="mb-3">
                            <label htmlFor="imageUrl">Upload a Profile Picture (Optional)</label>
